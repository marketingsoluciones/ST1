...
bg-transparent border-transparent rounded-lg border-solid border cursor-pointer inline-block font-bold text-sm leading-none py-4 px-8 text-center no-underline select-none align-middle" */
/* ⚠️ Some properties could not be matched with Tailwind classes. Use @apply to extend a CSS rule: */
.btn {
  @apply bg-transparent border-transparent rounded-lg border-solid border cursor-pointer inline-block font-bold text-sm leading-none py-4 px-8 text-center no-underline select-none align-middle;
  color: rgba(118, 121, 136, 1);
  transition: color 0.15s ease-in-out, background-color 0.15s ease-in-out,
    border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out,
    -webkit-box-shadow 0.15s ease-in-out;

    /* ✨ TailwindCSS: "border-0 text-white hover:text-white" */
/* ⚠️ Some properties could not be matched with Tailwind classes. Use @apply to extend a CSS rule: */
.btn-warning {
  @apply border-0 text-white hover:text-white;
  border-color: rgba(252, 116, 24, 1);
  background-color: rgba(252, 116, 24, 1);
}
